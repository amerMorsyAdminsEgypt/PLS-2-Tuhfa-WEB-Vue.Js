<template>
  <div class="fab-container">
    ...
    <ul class="fab-options">
      <li v-if="checkPrivilege(hasSocialStatuseAdd())">
        <span class="fab-label">
          <router-link :to="{ name: 'SocialStatuseAdd' }" class="">
            {{ $t("SocialStatuses.add") }}
          </router-link>
        </span>
...
import { hasSocialStatuseAdd } from "@/utils/privilegeHelper";
