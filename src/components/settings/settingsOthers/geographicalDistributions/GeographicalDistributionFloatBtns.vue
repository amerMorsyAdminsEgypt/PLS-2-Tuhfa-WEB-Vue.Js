<template>
  <div class="fab-container">
    ...
    <ul class="fab-options">
      <li v-if="checkPrivilege(hasGeographicalDistributionAdd())">
        <span class="fab-label">
          <router-link :to="{ name: 'GeographicalDistributionAdd' }" class="">
            {{ $t("GeographicalDistributions.add") }}
          </router-link>
        </span>
...
import { hasGeographicalDistributionAdd } from "@/utils/privilegeHelper";
