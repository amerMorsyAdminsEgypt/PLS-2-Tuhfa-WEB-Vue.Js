<template>
  <div class="fab-container">
    ...
    <ul class="fab-options">
      <li v-if="checkPrivilege(hasMilitaryStatusTypeAdd())">
        <span class="fab-label">
          <router-link :to="{ name: 'MilitaryStatusTypeAdd' }" class="">
            {{ $t("MilitaryStatusTypes.add") }}
          </router-link>
        </span>
...
import { hasMilitaryStatusTypeAdd } from "@/utils/privilegeHelper";
